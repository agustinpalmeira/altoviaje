...
class DashboardViewController: UIViewController {
    ...
    let destinies: [Destiny] = [Destiny(place: "Bariloche",
                                        ...
                                        estimatedPrize: 6500,
                                        activities: [
                                            Activity(name: "Cerro Tronador", description: "El cerro Tronador es un volcán geológicamente inactivo. Su altura de 3554 msnm lo destaca entre los macizos montañosos del Parque nacional Nahuel Huapi. El Tronador posee un total de siete glaciares distrubuidos en su superficie", date: Date(timeInterval: 86400, since: Date())),
                                            Activity(name: "Cerro Catedral", description: "El cerro Catedral es una montaña ubicada en San Carlos de Bariloche, a 19 kilómetros del centro de la ciudad y dentro del Parque Nacional Nahuel Huapi. Es el centro de esquí más grande de Sudamérica", date: Date(timeInterval: 86400 * 2, since: Date()))]),
                                Destiny(place: "Iguazu",
                                        description: "Bariloche es una ciudad ubicada entre bosques milenarios, montañas cubiertas de nieve y lagos cristalinos, en la provincia de Río Negro, Argentina. Se trata de una postal de nuestra Patagonia. Una ciudad anfitriona por excelencia, enmarcada por algunas de las bellezas naturales más importantes del país.",
                                        image: #imageLiteral(resourceName: "Iguazu"),
                                        estimatedPrize: 6200,
                                        activities: [
                                            Activity(name: "Cataratas del Iguazu", description: "Las majestuosas Cataratas del Iguazú se encuentran en el interior del Parque Nacional Iguazú, un área de preservación de la naturaleza que abarca 67.720 hectáreas en el extremo norte de la Provincia de Misiones, en la República Argentina.", date: Date(timeInterval: 86400, since: Date())),
                                            Activity(name: "Minas de Wanda", description: "Ubicadas a 40 kilómetros de Puerto Iguazú y a 260 de Posadas, se encuentran las famosas Minas de Wanda, en un yacimiento de piedras semipreciosas de cristales de cuarzo, amatistas, ágatas y topacios, entre las más importantes.", date: Date(timeInterval: 86400*2, since: Date()))]),
                                Destiny(place: "Salta",
                                        description: "Bariloche es una ciudad ubicada entre bosques milenarios, montañas cubiertas de nieve y lagos cristalinos, en la provincia de Río Negro, Argentina. Se trata de una postal de nuestra Patagonia. Una ciudad anfitriona por excelencia, enmarcada por algunas de las bellezas naturales más importantes del país.",
                                        image: #imageLiteral(resourceName: "Salta"),
                                        estimatedPrize: 7200,
                                        activities: [
                                            Activity(name: "Tren a las Nubes", description: "Un viaje en plena puna salteña que combina sus servicios en dos tramos, para luego embarcar a la mágica experiencia del Tren a las Nubes.", date: Date(timeInterval: 86400, since: Date())),
                                            Activity(name: "Salinas Grandes", description: "Las Salinas Grandes consisten en un salar que se extienden hasta donde alcanza la vista, perdiéndose en el horizonte.", date: Date(timeInterval: 86400*2, since: Date())),
                                            Activity(name: "Santa Rosa de Tastil", description: "Las Ruinas de Tastil, declaradas Monumento Histórico Nacional fue la ciudad precolombina más grande ubicada en el actual territorio argentino.", date: Date(timeInterval: 86400*3, since: Date())),
                                            Activity(name: "Cafayate", description: "La ciudad de Cafayate se encuentra rodeada de las maravillas que el tiempo ha llegado a formar con sus llamativas y coloridas formaciones rocosas tales como la garganta del diablo, el anfiteatro, el sapo, el fraile, el obelisco y las ventanas", date: Date(timeInterval: 86400*4, since: Date()))])]
