...
class DashboardViewController: UIViewController {
    ...
    let destinies: [Destiny] = [Destiny(place: "Bariloche",
                                        ...
                                        activities: [
                                            ...
                                            Activity(name: BarilocheItinerary.catedralExcursion, description: "El cerro Catedral es una montaña ubicada en San Carlos de Bariloche, a 19 kilómetros del centro de la ciudad y dentro del Parque Nacional Nahuel Huapi. Es el centro de esquí más grande de Sudamérica", date: Date(timeInterval: 86400 * 2, since: Date()))]),
                                ...
                                Destiny(place: "Salta",
                                        ...
                                        estimatedPrize: 7200,
                                        activities: [
                                            Activity(name: SaltaItinerary.trenNubesExcursion, description: "Un viaje en plena puna salteña que combina sus servicios en dos tramos, para luego embarcar a la mágica experiencia del Tren a las Nubes.", date: Date(timeInterval: 86400, since: Date())),
                                            Activity(name: SaltaItinerary.salinasGrandesExcursion, description: "Las Salinas Grandes consisten en un salar que se extienden hasta donde alcanza la vista, perdiéndose en el horizonte.", date: Date(timeInterval: 86400*2, since: Date())),
                                            Activity(name: SaltaItinerary.tastilExcursion, description: "Las Ruinas de Tastil, declaradas Monumento Histórico Nacional fue la ciudad precolombina más grande ubicada en el actual territorio argentino.", date: Date(timeInterval: 86400*3, since: Date())),
